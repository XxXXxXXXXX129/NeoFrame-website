...
function Contact() {
  const [formData, setFormData] = useState({
    ...
    phone: '',
    message: '',
    interest: 'purchase', // purchase, support, business
    model: 'lite' // lite, standard, pro
  });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              >
                Send Message
              </button>
            </form>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:contact@neoframe.com" className="text-emerald-400 hover:text-emerald-300">
                      contact@neoframe.com
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
